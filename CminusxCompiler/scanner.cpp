...
AlphaBeta ChrToAlpBt(char nxtchr)   //将初始字符转化为字母表枚举类型
{
    /**
    LETTER, DIGIT,
...
int BinSearResvd(string tknval) //根据字符串返回保留字列表的下标, 如果不在其中就返回-1
{
...
TokenType AcptToTknTp(State nowstate, string tknval)   //从一个字符串和一个接受状态得到记号的类型
{
